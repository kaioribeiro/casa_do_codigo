...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="public_html/_css/index.css"/>
    ...
    <body><div class="container">
            ...
            <div class="row" id="linha-conteudo">
                ...
                <!--Primeira Linha--> 
                <div class="col-md-offset-3 col-md-pull-8" id="col-lateral-direita">

                    <img id="img-logo" src="public_html/_imagens/tela-principal.png"/>
                    <nav id="figuras">
                        <ul>
