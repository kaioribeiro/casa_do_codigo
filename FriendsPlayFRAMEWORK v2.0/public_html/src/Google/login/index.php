...
$google_developer_key 	= '4/wFkez3MBktwUT2TPtz7dco9ndaCNiFnBpUZNOdNSIQA';

########## MySql details (Replace with yours) ############# //É necessário um banco de dados para salvar os dados do usuário.
$db_username = "xxxxxxxxx"; //Database Username
$db_password = "xxxxxxxxx"; //Database Password
$hostname = "localhost"; //Localização do banco de dados SQL
...
$gClient->setApplicationName('Login do aplicativo Friends Play');
